   ...
   <body>
       ...
       ?>
          <div class='fiche'>
            ...
            <a href='<?php echo $path_img."/".htmlentities($id_tableau).".jpg" ?>' target='_blank'><img class='imgFiche' src='<?php echo $path_img."/".htmlentities($id_tableau).".jpg" ?>' height='300'></a><br>
