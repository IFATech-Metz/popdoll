                ...
                <div>
                    ...
                    <form class='ajout' action='' method='POST' enctype='multipart/form-data'>
                        ...
                        <div class='left'>TITRE:<br> 
                        	<input type='text' class='textInput' name='titre' value="<?php echo $tableau['TITRE'] ?>">
                        </div>

                        <div class='right'>CATEGORIE:<br>
                        	<input type='text' class='textInput' name='cat' value="<?php echo $tableau['CAT'] ?>">
                    	</div>

                        <br><br><br>

                        <div class='center'>DESCRIPTION:<br>
                        	<input type='text' class='textInput' name='desc' style="width: 80%; height: 40px" value="<?php echo $tableau['DESC'] ?>">
                        </div>
